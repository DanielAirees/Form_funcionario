...
# Criando o Frame Formulário
        ...
        self.ent_nome = ctk.CTkEntry(self.frame_formulario, width=200, corner_radius=5, height=15)

        self.rg = ctk.CTkLabel(self.frame_formulario, text='RG', font=('Helvetica', 14))
        self.ent_rg = ctk.CTkEntry(self.frame_formulario, width=110, 
        ...
        self.ent_orgaoEmissor = ctk.CTkEntry(self.frame_formulario, width=80, corner_radius=5, height=15)

        self.cpf = ctk.CTkLabel(self.frame_formulario, text='CPF', font=('Helvetica', 14))
        self.ent_cpf = ctk.CTkEntry(self.frame_formulario, width=130, placeholder_text='Apenas números', corner_radius=5, height=15)
        ...
        self.combo_genero = ctk.CTkComboBox(
            self.frame_formulario, values=self.genero_lista, width=130, corner_radius=5, font=('Helvetica', 12), height=15)
        
        self.ddd = ctk.CTkLabel(self.frame_formulario, text='DDD', font=('Helvetica', 14))
        self.ent_ddd = ctk.CTkEntry(self.frame_formulario, width=60, corner_radius=5, height=15)
        
        self.tel = ctk.CTkLabel(self.frame_formulario, text='Telefone', font=('Helvetica', 14))
        self.ent_tel = ctk.CTkEntry(self.frame_formulario, width=130, corner_radius=5, height=15)
...
# --------------------------------------------------------------------------------- 
        ...
        # self.linha = ttk.Separator(self.frame_endereco, orient='horizontal')
        ...
        self.ent_cep = ctk.CTkEntry(self.frame_endereco, width=100, corner_radius=5, height=15)

        self.cidade = ctk.CTkLabel(self.frame_endereco, text='Cidade', font=('Helvetica', 14))
        self.ent_cidade = ctk.CTkEntry(self.frame_endereco, width=150, corner_radius=5, height=15)
        ...
        self.combo_estado = ctk.CTkComboBox(
            self.frame_endereco, values=self.estado_lista, width=60, corner_radius=5, font=('Helvetica', 12), height=15)

        self.bairro = ctk.CTkLabel(self.frame_endereco, text='Bairro', font=('Helvetica', 14))
        self.ent_bairro = ctk.CTkEntry(self.frame_endereco, width=220, corner_radius=5, height=15)

        self.rua = ctk.CTkLabel(self.frame_endereco, text='Rua', font=('Helvetica', 14))
        self.ent_rua = ctk.CTkEntry(self.frame_endereco, width=220, corner_radius=5, height=15)

        self.numero = ctk.CTkLabel(self.frame_endereco, text='Número', font=('Helvetica', 14))
        self.ent_numero = ctk.CTkEntry(self.frame_endereco, width=50, corner_radius=5, height=15)
        ...
        self.ent_complemento = ctk.CTkEntry(self.frame_endereco, width=160, corner_radius=5, 
                                            height=15,placeholder_text='(opcional)')
...
# --------------------------------------------------------------------------------- 
        ...
        self.ent_id = ctk.CTkEntry(self.frame_dados_prof, width=100, corner_radius=5, height=15)
        ...
        self.ent_cargo = ctk.CTkEntry(self.frame_dados_prof, width=130, corner_radius=5, height=15)
        ...
        self.combo_area = ctk.CTkComboBox(
            self.frame_dados_prof, values=self.area_lista, width=130, corner_radius=5, font=('Helvetica', 12), height=15)
        ...
        self.combo_nivel = ctk.CTkComboBox(
            self.frame_dados_prof, values=self.nivel_lista, width=130, corner_radius=5, font=('Helvetica', 12), height=15)
        
        self.salario = ctk.CTkLabel(self.frame_dados_prof, text='Salário', font=('Helvetica', 14))
        self.ent_salario = ctk.CTkEntry(self.frame_dados_prof, width=130, corner_radius=5, height=15)
...
# Criando um frame para organizar a TreeView
        ...
        self.treeview.column("telefone", width=200)
        self.treeview.column("cep", width=75)
        ...
        self.treeview.column("numero", width=50)
...
# ---------------------------------------------------------------------------------
    def apresentarRegistrosSelecionados(self, event):
        ...
        for selection in self.treeview.selection():
            ...
            self.ent_dt_nasc.insert(0, data_nascimento)
            ...
            self.ent_dt_contratacao.insert(0, data_contratacao)
...
# ---------------------------------------------------------------------------------
    def pegar_dados(self):
        ...
        salario = int(self.ent_salario.get())
